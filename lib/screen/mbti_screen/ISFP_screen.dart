...
class ISFPScreen extends StatelessWidget {
  const ISFPScreen({super.key});
            ...
            children: [
              ...
              const Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                      " 말없이 다정하고 온화하며 사람들에게 친절하고 상대방을 잘 알게 될 때까지 내면의 모습이 잘 보이지 않습니다. 의견 충돌을 피하고, 인화를 중시합니다. 인간과 관계되는 일을 할 때 자신의 감정과 타인의 감정에 지나치게 민감한 경향이 있습니다.",
                      softWrap: true,
                    ),
                  ),
                ],
              ...
              const WriteExplain(explain: "화가 나더라도 차분하고 친절하게 의견을 표현한다."),
              const WriteExplain(explain: "남에게 싫은 소리 못하고 속으로 삭인다."),
              const WriteExplain(explain: "다른 사람의 부탁을 거절하기 어려워한다."),
              const WriteExplain(explain: "분쟁을 싫어하며 조화롭게 지내고자 노력한다."),
              const WriteExplain(explain: "전화보다 메시지를 선호한다."),
              const WriteExplain(explain: "첫인상은 차갑고 수줍어보이나 알고보면 꽤 순둥이다."),
              const WriteExplain(explain: "개인주의적 성향이 강하며 독립적이다."),
              const WriteExplain(explain: "외향성이 강한 상대와 있으면 활동성에 지치기 쉽다."),
              const SizedBox(
                height: 15,
              ),
              const Row(
              ...
              const Row(
                children: [
                  Expanded(
                    child: Text(
                      "보석 세공사, 도예가, 고고학자, 천문학자, 치과 위생사, 간호사, 사무원",
                    ),
                  ),
                ],
              ),
              ...
              const Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                      " 연애할 때 상당히 신중한 편으로 오랫동안 짝사랑을 하는 경우가 많습니다. 하지만 거절당하는 것을 두려워하기때문에 고백하지 못하고 혼자 속으로 좋아하다가 끝나는 편입니다. 은근 모쏠이 많은 유형입니다. 에너지가 쉽게 방전되는 유형이기 때문에 주기적으로 혼자만의 시간이 필요합니다.",
                      softWrap: true,
                    ),
                  ),
                ],
